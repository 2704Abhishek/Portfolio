/* ═══════════════════════════════════════════════════════════
   Abhishek Yadav Portfolio — Enhanced Animations Script
  ...
  if (chatTrigger && chatPanel && chatClose) {
    chatTrigger.addEventListener('click', () => {
      ...
      if (chatHistory.length === 0) {
        setTimeout(() => addMessage('Hey 👋 I’m Abhishek. Feel free to ask me anything about my work, projects, or experience.', 'ai'), 300);
      }
    });
